...
----
include::{sourceDir}/src/main/groovy/example/micronaut/BintrayPackage.groovy[]
----
...
----
include::{sourceDir}/src/main/groovy/example/micronaut/BintrayLowLevelClient.groovy[]
----
